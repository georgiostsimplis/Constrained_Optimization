...
plot(0.6383,15,'Xr','LineWidth',4)
legendInfo{8}=['minimal risk'];
legend(legendInfo);
...
plot(sol1(2,66),sol1(1,66),'X','LineWidth',2)
plot(sol2(2,66),sol2(1,66),'X','LineWidth',2)
plot(sol3(2,66),sol3(1,66),'X','LineWidth',2)
plot(sol4(2,66),sol4(1,66),'X','LineWidth',2)
plot(sol5(2,66),sol5(1,66),'X','LineWidth',2)
plot(sol6(2,66),sol6(1,66),'X','LineWidth',2)

legend('security 1','security 2','security 3','security 4',...
    'security 5','free risk sec.')
ylabel("Portfolio's weighting  factors ")
xlabel("Return")
hold off
%========optimal portfolio results for R=15=========%
H = [2.3 0.93 0.62 0.74 -0.23 0;
     0.93 1.4 0.22 0.56 0.26 0;
     0.62 0.22 1.8 0.78 -0.27 0;
     0.74 0.56 0.78 3.4 -0.56 0;
...
lb=zeros(6,1); ub=ones(6,1);
R=15; beq=[R;1];
disp("==== Optimal Portfolio with risky security at R=15 ====")
[x,fval] = quadprog(H,f,[],[],Aeq,beq,lb,ub,x0,options)